        ...
        <ScrollArea className="max-h-[calc(100vh-53px)]">
          <div className="flex w-full flex-1 flex-col text-sm">
            {conversations.results.map((conversation) => {
              ...
              const country = getCountryNameFromTimezone(
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-1 flex items-center justify-baseline gap-2">
            ...
            <div className="flex items-start gap-3 rounded-lg p-4" key={index}>
              ...
              <div className="min-w-0 flex-1">
                <div className="flex w-full items-center gap-2">
                  ...
                  <Skeleton className="h-3 w-12 shrink-0 ml-auto" />
                </div>
                <div className="mt-2">
